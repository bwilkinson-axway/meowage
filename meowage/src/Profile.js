    ...
    return (
      <div className="profile">
        ...
        <div className='content'>
          ...
          <button onClick={() => this.handleClick()}><img id='matches' src={this.props.state.meow.includes(parseInt(index) + 1) ? 'https://clipart.info/images/ccovers/1495818555cartoon-fire-flames-emoji-png-transparent.png' : "https://www.actaturcica.com/wp-content/uploads/2018/06/Match-Stick-PNG-Transparent-Image.png"} alt='matches'></img></button>
          <h4> {this.props.state.meow.includes(parseInt(index) + 1) ? "Email: " + this.props.state.cats[index].email : ""} </h4>
        </div>
      </div>
    );
  }
