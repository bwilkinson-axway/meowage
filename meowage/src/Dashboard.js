...
function Dashboard({ history }) {
  return (
    <div class='dashboard'>
      ...
      <div class='meowmeows'>
        <div onClick={() => history.push('/profile')} class='thumb'>
          <img class='profpic' src="https://easysunday.com/blog/wp-content/uploads/2017/11/cat.jpg" alt='cat profile pic'></img>
          <h5> Catticus Finch </h5>
        </div>
        <div onClick={() => history.push('/profile')} class='thumb'>
          <img class='profpic' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9PF7oK_J5NFa_N_yU_tZo-GyqMRFSXheHXjQeCoq5Vzx3TfuA8A" alt='cat profile pic'></img>
          <h5> Miz Kitty </h5>
        </div>
        <div onClick={() => history.push('/profile')} class='thumb'>
          <img class='profpic' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgqR68owng0H_fCod-If9Y5l4r02lYi6lOc9GvdsaQ8eg6hy65Tw" alt='cat profile pic'></img>
          <h5> Fluffy </h5>
        </div>
        ...
        <div onClick={() => history.push('/profile')} class='thumb'>
          <img class='profpic' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQLzxb06pETCtdF-uX-r1FTGl1czazzA4S8r7CmQozocSvtGJ86-A" alt='cat profile pic'></img>
          <h5> Sake </h5>
        </div>
        <div onClick={() => history.push('/profile')} class='thumb'>
          <img class='profpic' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPq69NqSwTly8LNqI24fRskF9NKM47-RyzKrm8jvCG0lBa2nUI" alt='cat profile pic'></img>
          <h5> Snookums </h5>
        </div>
        <div onClick={() => history.push('/profile')} class='thumb match'>
        ...
        <div onClick={() => history.push('/profile')} class='thumb'>
          <img class='profpic' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT57ZurVb3Goqf7VomkoAxQi5QrSfaAgPpVjc2p4g8MZ76rG5kPug" alt='cat profile pic'></img>
          <h5> Garfield </h5>
        </div>
        <div onClick={() => history.push('/profile')} class='thumb'>
        ...
        <div onClick={() => history.push('/profile')} class='thumb'>
          <img class='profpic' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQp5NJ2X5LGo4tPV15ezKhtZ8-NShJVdelLaW1Y0Wukm5q0Ma5jlw" alt='cat profile pic'></img>
          <h5> Nibblits </h5>
        </div>
        <div onClick={() => history.push('/profile')} class='thumb'>
          <img class='profpic' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpriVlrn_CyvIrT66TyoS39vLIxI9mskVWffT2XkVS0pUaCCoq" alt='cat profile pic'></img>
          <h5> Bender </h5>
        </div>
      </div>
    </div>
